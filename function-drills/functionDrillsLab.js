...
let nameGreeting = nameCheck(`Camden`)
...
const hogwartsExpressTrolley = gold => {
  let chocolateFrogs = gold / 3
  return `You bought ${chocolateFrogs} Chocolate Frogs!`
}

let totalFrogs = hogwartsExpressTrolley(9)
...
const hogwartsExpressTrolley2 = gold => {
  let chocolateFrogs = Math.floor(gold / 3)
  return `You bought ${chocolateFrogs} Chocolate Frogs!`
}

let totalFrogs2 = hogwartsExpressTrolley2(8)
